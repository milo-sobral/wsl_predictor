...
def get_round_info(html) :
    ...
    heats = soup.find_all(class_ = 'new-heat')
    for l in heats :
        get_heat_info(l.prettify())
...
def main() :
    data = data_from_page('http://www.worldsurfleague.com/events/2008/mct/4/quiksilver-pro-gold-coast?roundId=69')
